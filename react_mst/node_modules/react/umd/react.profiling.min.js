...
b)};c.useMemo=function(a,b){return f.current.useMemo(a,b)};c.useReducer=function(a,b,c){return f.current.useReducer(a,b,c)};c.useRef=function(a){return f.current.useRef(a)};c.useState=function(a){return f.current.useState(a)};c.useSyncExternalStore=function(a,b,c){return f.current.useSyncExternalStore(a,b,c)};c.useTransition=function(){return f.current.useTransition()};c.version="18.0.0-rc.1-experimental-629036a9c-20220224"});
})();
