...
exports.drawColorBlock = drawColorBlock;
exports.drawPipette = drawPipette;
exports.drawPipetteCanvas = drawPipetteCanvas;
exports.drawTooltip = drawTooltip;
exports.getCanvas = getCanvas;
exports.getCanvasRectColor = void 0;
exports.hex = hex;
exports.renderColorInfo = exports.rbgaObjToRgba = exports.rbgaObjToHex = exports.loadImage = void 0;
...
const loadImage = base64 => {
  return new Promise(resolve => {
    ...
    img.onload = () => resolve(img); // @ts-ignore
...
exports.rbgaObjToHex = rbgaObjToHex;

const rbgaObjToRgba = rgba => {
  const {
    r,
    g,
    b,
...
exports.rbgaObjToRgba = rbgaObjToRgba;

const renderColorInfo = params => {
  const {
    containerDom,
    color,
    colors,
...
exports.renderColorInfo = renderColorInfo;

function drawPipette(colors, size = 8) {
  const scale = 2;
...
function drawPipetteCanvas(colors, size) {
...
const getCanvasRectColor = (ctx, rect, scale = 1) => {
  const {
    x,
    y,
    width,
    height
  } = rect; // console.log(x, y, width, height);
...
exports.getCanvasRectColor = getCanvasRectColor;