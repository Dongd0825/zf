  ...
  "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var enableClientRenderFallbackOnHydrationMismatch = true;
        ...
        function scheduleUpdateOnFiber(fiber, lane, eventTime) {
          ...
          if ((executionContext & RenderContext) !== NoLanes && root2 === workInProgressRoot) {
            ...
            if (root2.isDehydrated && root2.tag !== LegacyRoot) {
              if (workInProgressRoot === root2) {
                prepareFreshStack(root2, NoLanes);
              }
              root2.isDehydrated = false;
              var error2 = new Error("This root received an early update, before anything was able hydrate. Switched the entire root to client rendering.");
              var onRecoverableError = root2.onRecoverableError;
              onRecoverableError(error2);
            } else if (root2 === workInProgressRoot) {
        ...
        function recoverFromConcurrentError(root2, errorRetryLanes) {
          if (root2.isDehydrated) {
            ...
            var error2 = new Error("There was an error while hydrating. Because the error happened outside of a Suspense boundary, the entire root will switch to client rendering.");
            renderDidError(error2);
          }
        ...
        function createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
        ...
        function createContainer(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
          return createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
        }
        function createHydrationContainer(initialChildren, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError, transitionCallbacks) {
          var hydrate2 = true;
          var root2 = createFiberRoot(containerInfo, tag, hydrate2, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
        ...
        function createRoot(container, options2) {
          ...
          var root2 = createContainer(container, ConcurrentRoot, false, null, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
        ...
        function hydrateRoot(container, initialChildren, options2) {
          ...
          var root2 = createHydrationContainer(initialChildren, container, ConcurrentRoot, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
          markContainerAsRoot(root2.current, container);
        ...
        function legacyCreateRootFromDOMContainer(container, forceHydrate) {
          ...
          var root2 = createContainer(container, LegacyRoot, forceHydrate, null, false, false, "", noopOnRecoverableError);
          markContainerAsRoot(root2.current, container);
          var rootContainerElement = container.nodeType === COMMENT_NODE ? container.parentNode : container;
          listenToAllSupportedEvents(rootContainerElement);
          return root2;
